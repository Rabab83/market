...
class _CalenderState extends State<Calender> {
  ...
  void initState() {
    ...
    _selectedTasks = [];
       ...
       // Function that returns the same date Events
  Map<DateTime, List<dynamic>> _groupTasks(List<TaskModel> tasks) {
    Map<DateTime, List<dynamic>> data = {};
    tasks.forEach((task) {
      DateTime date = DateTime(task.taskDate.year, task.taskDate.month, task.taskDate.day, 12);
